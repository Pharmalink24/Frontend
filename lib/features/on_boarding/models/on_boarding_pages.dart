...
List<OnBoardingPageModel> onBoardingPages = [
  OnBoardingPageModel(
    ...
    titleInArabic: "تطبيق مصاحب مبسط.",
    body:
  ...
  OnBoardingPageModel(
    ...
    titleInArabic: "تنبيهات التفاعلات الدوائية في الوقت الفعلي.",
    body:
  ...
  OnBoardingPageModel(
    ...
    titleInArabic: "نظام وصفات طبية رقمي بنسبة 100٪.",
    body:
  ...
  OnBoardingPageModel(
    ...
    titleInArabic: "عمليات مبنية على السحاب.",
    body:
