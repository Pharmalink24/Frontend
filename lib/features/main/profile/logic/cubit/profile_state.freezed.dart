...
class _$UploadProfileImageLoadingImpl<T>
  ...
  @override
  String toString() {
    return 'ProfileState<$T>.uploadProfileImageLoading()';
  }
...
abstract class UploadProfileImageLoading<T> implements ProfileState<T> {
...
class _$UploadProfileImageSuccessImpl<T>
  ...
  @override
  String toString() {
    return 'ProfileState<$T>.uploadProfileImageSuccess(data: $data)';
  }
...
abstract class UploadProfileImageSuccess<T> implements ProfileState<T> {
...
class _$UploadProfileImageErrorImpl<T> implements UploadProfileImageError<T> {
  ...
  @override
  String toString() {
    return 'ProfileState<$T>.uploadProfileImageError(error: $error)';
  }
...
abstract class UploadProfileImageError<T> implements ProfileState<T> {
