...
import '../../features/main/prescription/prescription.dart';
import '../../features/main/prescription/landing_prescription.dart';

class AppRouter {
  Route generateRoute(RouteSettings settings) {
    switch (settings.name) {
      case Routes.initialRoute:
        return MaterialPageRoute(builder: (_) => const LandingPrescriptionScreen());
